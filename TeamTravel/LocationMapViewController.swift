 ...
 */
@objc public protocol LocationListDrawerDelegate: class {
    
    @objc optional func drawerPositionDidChange(drawer: LocationMapViewController)
    @objc optional func makeUIAdjustmentsForFullscreen(progress: CGFloat)
    @objc optional func drawerChangedDistanceFromBottom(drawer: LocationMapViewController, distance: CGFloat)
}
 ...
 */
public protocol PulleyDrawerViewControllerDelegate: LocationListDrawerDelegate {
 ...
 */
public protocol PulleyPrimaryContentControllerDelegate: LocationListDrawerDelegate {
...
open class LocationMapViewController: UIViewController, UIScrollViewDelegate, LocationTVCPassthroughScrollViewDelegate {
    ...
    private let drawerScrollView: LocationTVCPassthroughScrollView = LocationTVCPassthroughScrollView()
    ...
    public weak var delegate: LocationListDrawerDelegate?
    ...
    override open func loadView() {
        ...
        dimmingViewTapRecognizer = UITapGestureRecognizer(target: self, action: #selector(LocationMapViewController.dimmingViewTapRecognizerAction(gestureRecognizer:)))
